...
class AgainScreen extends React.Component {
  ...
  componentDidMount() {
      ...
      //  var nxt = moment().add(2, 'days').format('ddd');
         ...
         // alert(JSON.stringify(GLOBAL.booking.shop_id))
  }
...
setValue=(add2, add3)=> {
   ...
   GLOBAL.reshed_date = add3

   if (GLOBAL.booking.shop_id == 0) {
  ...
  const url = GLOBAL.BASE_URL +  'time_slots'
          ...
          this.showLoading()
            ...
            body: JSON.stringify({
              ...
              "date": add3,
              "shop_id": GLOBAL.booking.shop_id
...
<TouchableOpacity style={{height:74,width:74,borderRadius:6,marginLeft:10,marginTop:15,backgroundColor:'white',elevation:3,marginBottom:15}}
 ...
 setValueAgain=(item)=>{
  ...
  resheduleService=()=> {
    ...
    const url = GLOBAL.BASE_URL +  'reschedule_booking'
          ...
          this.showLoading()
            ...
            body: JSON.stringify({
              ...
              "appointment_date":GLOBAL.reshed_date,
              "appointment_time": GLOBAL.reshed_time,
          ...
          <SafeAreaProvider style={{backgroundColor:'#e3e3e3'}}>
                   ...
                   <StatusBar backgroundColor="black" barStyle="light-content" />
                      ...
                      <View style = {{height:60,backgroundColor:'black',flexDirection:'row',width:'100%',alignItems:'center'}}>
                        ...
                        <Text style = {{color:'white',fontFamily:'Poppins-Medium',fontSize: 20,marginLeft:18,marginTop:3}}>
                          Reschedule Service
                  ...
                  {this.state.imgchange==0 && (
                    ...
                    :'center'}} onPress={()=>this.setaddress()}>
                       ...
                       <Text style={{fontSize:16,fontFamily:'Poppins-SemiBold',color:'white',alignSelf:'center'}}>Reschedule</Text>
                    ...
                    :'center'}} onPress={()=>this.resheduleService()}>
